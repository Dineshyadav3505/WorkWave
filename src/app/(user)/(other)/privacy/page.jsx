    ...
    <div className="px-5">
      <div className="px-5 mx-auto my-10 py-10 max-w-3xl justify-items-center rounded-lg shadow-lg transition-transform transform">
        <h1 className="text-4xl font-bold mb-6 text-center">
          Privacy Policy for Naukrivacancy
        </h1>

        <p className="mb-4">
          At Naukrivacancy, accessible from Naukrivacancy.com, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Naukrivacancy and how we use it.
        </p>
        ...
        <p className="mb-4">
          ...
          advertising partners of Naukrivacancy.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          Note that Naukrivacancy has no access to or control over these cookies
        ...
        <p className="mb-4">
          Naukrivacancy does not knowingly collect any Personal Identifiable
        ...
        <p className="mb-4">
          ...
          shared and/or collect in Naukrivacancy. This policy is not applicable
